...
export abstract class RateLimitProxy {
    ...
    /**
     * Constructs the rate limiter part for a proxy.
    ...
    /**
     * Returns the amount of requests that can be made before limiting the rate.
     * @returns The amount of requests that can be made within an interval before limiting the rate.
     */
    public getRateLimitAmount(): number {
        return this.rateLimiter.points;
    }

    /**
     * Returns the duration of which the amount of requests can be made in before triggering a rate limit,
     * @returns The duration of which the amount of requests can be made in before triggering a rate limit,
     */
    public getRateLimitInterval(): number {
