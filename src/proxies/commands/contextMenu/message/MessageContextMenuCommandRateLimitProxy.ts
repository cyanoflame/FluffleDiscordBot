 ...
 */
export class MessageContextMenuCommandRateLimitProxy extends MessageContextMenuCommand {
     ...
     */
    public override async checkUsability(interaction: MessageContextMenuCommandInteraction): Promise<void> {
     ...
     */
    public override async execute(client: Client, interaction: MessageContextMenuCommandInteraction, data: EventData): Promise<void> {
