import { type LocalizationMap, type InteractionContextType, type Permissions, type ApplicationIntegrationType, type Client, type UserContextMenuCommandInteraction, type RESTPostAPIApplicationCommandsJSONBody, GuildChannel, ThreadChannel, type PermissionsString } from "discord.js";
 ...
 */
export class UserContextMenuCommandPermissionProxy implements ContextMenuCommand {
     ...
     */
    constructor(permissions: PermissionsString[], command: UserContextMenuCommand) {
        // Store the required permissions
     ...
     */
    public async checkUsability(interaction: UserContextMenuCommandInteraction): Promise<void> {
     ...
     */
    public async execute(client: Client, interaction: UserContextMenuCommandInteraction, data: EventData): Promise<void> {
