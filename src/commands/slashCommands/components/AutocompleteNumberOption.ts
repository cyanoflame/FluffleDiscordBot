...
/**
 * This class is inteded to be extended when a user needs to create an number option that has autocomplete functionality.
 */
export class AutocompleteNumberOption extends SlashCommandNumberOption implements AutocompleteOption {
    ...
    /**
     * This creates the autocomplete number option. It automatically sets the autocomplete option to true.
     */
    constructor() {
        super();
